...
#define OVK_ClassId_Kernel_KernelLog                         OpenViBE::CIdentifier(0x1FE5CF01, 0x0B2B3748)
#define OVK_ClassId_Kernel_KernelLogConsole                  OpenViBE::CIdentifier(0x1EEB056C, 0x373C17C7)
#define OVK_ClassId_Kernel_KernelLogDebug                    OpenViBE::CIdentifier(0x45C1A72F, 0x647DE336)
#define OVK_ClassId_Kernel_KernelLogNull                     OpenViBE::CIdentifier(0x1341E7E6, 0x2232EB75)
...
#define OVK_ClassId_Kernel_BoxContext                        OpenViBE::CIdentifier(0x59B7AE07, 0x4A6FE704)
#define OVK_ClassId_Kernel_BoxContextInput                   OpenViBE::CIdentifier(0x18FC58E0, 0x505E97CD)
...
/*
#define OV_ClassId_                                        OpenViBE::CIdentifier(0x72D4050C, 0x543DDAD8)
#define OV_ClassId_                                        OpenViBE::CIdentifier(0x78606B83, 0x5EB11EC9)
#define OV_ClassId_                                        OpenViBE::CIdentifier(0x17DC0F51, 0x795A3A7E)
