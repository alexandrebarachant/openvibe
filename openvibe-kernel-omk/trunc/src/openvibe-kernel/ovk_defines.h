...
#define OVK_ClassId_Kernel_ProcessingUnit                    OpenViBE::CIdentifier(0x3C581F28, 0x5A5E9C6B)
...
#define OVK_ClassId_Kernel_Player                            OpenViBE::CIdentifier(0x7C8777FF, 0x52CE89C2)

#define OVK_ClassId_Kernel_Message                           OpenViBE::CIdentifier(0x42A56E80, 0x289CBB09)
#define OVK_ClassId_Kernel_MessageClock                      OpenViBE::CIdentifier(0x3AA34472, 0x2B1F67CB)
#define OVK_ClassId_Kernel_MessageEvent                      OpenViBE::CIdentifier(0x036401EF, 0x31E90C38)
#define OVK_ClassId_Kernel_MessageSignal                     OpenViBE::CIdentifier(0x3BB1DDD9, 0x0B289F8D)
...
#define OVK_ClassId_Tools_ObjectFactoryHelper                OpenViBE::CIdentifier(0x6059EA7C, 0x081FDAB5)
...
/*
#define OVK_ClassId_                                         OpenViBE::CIdentifier(0x78071145, 0x308261A2)
#define OVK_ClassId_                                         OpenViBE::CIdentifier(0x4A46A96D, 0x6D4957C5)
