#ifndef __OpenViBEKernel_Kernel_CScenarioImporterContext_H__
#define __OpenViBEKernel_Kernel_CScenarioImporterContext_H__
...
#endif // __OpenViBEKernel_Kernel_CScenarioImporterContext_H__
