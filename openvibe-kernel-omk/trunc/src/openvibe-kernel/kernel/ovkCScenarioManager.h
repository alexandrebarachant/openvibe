#ifndef __OpenViBEKernel_Kernel_IScenarioManager_H__
#define __OpenViBEKernel_Kernel_IScenarioManager_H__
...
namespace OpenViBE
{
	namespace Kernel
	{
		...
		public:
			...
			CScenarioManager(OpenViBE::Kernel::IKernel& rKernel);
			...
			_IsDerivedFromClass_Final_(OpenViBE::Kernel::TKernelObject<OpenViBE::Kernel::IScenarioManager>, OVK_ClassId_Kernel_ScenarioManager);
...
#endif // __OpenViBEKernel_Kernel_IScenarioManager_H__
