#ifndef __OpenViBEKernel_Kernel_CPluginModule_H__
#define __OpenViBEKernel_Kernel_CPluginModule_H__
...
namespace OpenViBE
{
	namespace Kernel
	{
		...
		public:
			...
			CPluginModule(OpenViBE::Kernel::IKernel& rKernel);
			...
			_IsDerivedFromClass_Final_(OpenViBE::Kernel::IPluginModule, OVK_ClassId_Kernel_PluginModule)
...
#endif // __OpenViBEKernel_Kernel_CPluginModule_H__
