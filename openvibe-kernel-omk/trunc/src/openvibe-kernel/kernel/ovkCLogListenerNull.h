#ifndef __OpenViBEKernel_Kernel_CLogListenerNull_H__
#define __OpenViBEKernel_Kernel_CLogListenerNull_H__
...
namespace OpenViBE
{
	namespace Kernel
	{
		class CLogListenerNull : virtual public OpenViBE::Kernel::TKernelObject<OpenViBE::Kernel::ILogListener>
		{
		public:
			...
			_IsDerivedFromClass_Final_(OpenViBE::Kernel::TKernelObject<OpenViBE::Kernel::ILogListener>, OVK_ClassId_Kernel_LogListenerNull);
		};
	};
};

#endif // __OpenViBEKernel_Kernel_CLogListenerNull_H__
