...
namespace OpenViBEPlugins
{
	namespace Samples
	{
		...
		public:
			...
			{
				CScenarioExporterXMLWriterCB cb(rScenarioExporterContext.getFileName());
				...
				l_pWriter->openChild("OpenViBE");
				 l_pWriter->openChild("Scenario");
				  l_pWriter->openChild("Boxes");
					rScenarioExporterContext.getScenario().enumerateBoxes(bcb);
				  l_pWriter->closeChild();
				  l_pWriter->openChild("Links");
					rScenarioExporterContext.getScenario().enumerateLinks(lcb);
				  l_pWriter->closeChild();
				 l_pWriter->closeChild();
				l_pWriter->closeChild();
