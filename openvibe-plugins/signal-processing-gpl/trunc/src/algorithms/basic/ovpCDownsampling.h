...
namespace OpenViBEPlugins
{
	namespace SignalProcessingGpl
	{
		...
		public:
			...
			virtual OpenViBE::CString getDetailedDescription(void) const { return OpenViBE::CString("Downsamples input signal respect of the new sampling rate chosen by user."); }
