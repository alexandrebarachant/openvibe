#ifndef __OpenViBEPlugins_Acquisition_CGDFReader_H__
#define __OpenViBEPlugins_Acquisition_CGDFReader_H__
	...
	namespace Acquisition
	{
		...
		*/
		...
		public:
			...
			//EBML handling
			EBML::TWriterCallbackProxy1<OpenViBEPlugins::Acquisition::CGDFReader> * m_pOutputWriterCallbackProxy[3];
...
//			OpenViBEToolkit::IBoxAlgorithmStimulationOutputWriter * m_pStimulationOutputWriterHelper;
		...
		*/
		...
		public:
			...
			virtual void release(void) { }
			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("GDF reader"); }
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Acquisition::CGDFReader(); }
