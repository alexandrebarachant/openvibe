...
namespace OpenViBEPlugins
{
	namespace Acquisition
	{
		...
		public:
			...
			virtual OpenViBE::CString getDetailedDescription(void) const { return OpenViBE::CString("This algorithm waits for EEG data from the network and distribute it into the scenario"); }
