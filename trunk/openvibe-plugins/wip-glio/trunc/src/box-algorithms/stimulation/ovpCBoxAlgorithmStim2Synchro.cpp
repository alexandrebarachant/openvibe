...
// Init stim2sig. ----------------------------------------------------------------------------------------------------------------------------
OpenViBE::boolean CBoxAlgorithmStim2Synchro::initialize(void)
{
	/*
...
// UnInit stim2sig.  ----------------------------------------------------------------------------------------------------------------------------
OpenViBE::boolean CBoxAlgorithmStim2Synchro::uninitialize(void)
{
	/*
...
OpenViBE::boolean CBoxAlgorithmStim2Synchro::processInput(uint32 ui32InputIndex)
{
...
////> Process stim2sig. ----------------------------------------------------------------------------------------------------------------------------
OpenViBE::boolean CBoxAlgorithmStim2Synchro::process(void)
{
				...
				//		}
					...
					for(uint32 nbStimChunk=0;nbStimChunk<nbChunkStimulation;nbStimChunk++)
					{
						...
						if(	m_pStimulationDecoder->isOutputTriggerActive(OVP_GD_Algorithm_StimulationStreamDecoder_OutputTriggerId_ReceivedBuffer))
						{
							...
							//			{
											ip_pMatrixToEncode->getBuffer()[(l_nbChannels2-1)*l_nbSamples+chunk_relative_stim_index]=1;
							//			}
