...
IF(UNIX OR WIN32)
	...
	FIND_PROGRAM(Matlab_EXECUTABLE matlab PATHS $ENV{MATLABROOT} "$ENV{OV_DEP_MATLAB}/bin" NO_DEFAULT_PATH)
	FIND_PROGRAM(Matlab_EXECUTABLE MATLAB PATHS $ENV{MATLABROOT} "$ENV{OV_DEP_MATLAB}/bin" NO_DEFAULT_PATH)
	FIND_PROGRAM(Matlab_EXECUTABLE matlab PATHS $ENV{MATLABROOT} "$ENV{OV_DEP_MATLAB}/bin")
	FIND_PROGRAM(Matlab_EXECUTABLE MATLAB PATHS $ENV{MATLABROOT} "$ENV{OV_DEP_MATLAB}/bin")
