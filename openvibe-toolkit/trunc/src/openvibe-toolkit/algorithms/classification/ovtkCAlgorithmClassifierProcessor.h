...
{
	class OVTK_API CAlgorithmClassifierProcessor : public OpenViBEToolkit::TAlgorithm < OpenViBE::Plugins::IAlgorithm >
	{
	public:
	...
	class OVTK_API CAlgorithmClassifierProcessorDesc : public OpenViBE::Plugins::IAlgorithmDesc
	{
	public:
