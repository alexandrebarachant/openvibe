 ...
 *   OVTK_NodeId_StreamVersion (integer)
 ...
 *     OVTK_NodeId_Stimulation_Stimulation_SampleIndex (integer)
 *   OVTK_NodeId_Stimulation_Stimulation
 *   ...
 * OVTK_NodeId_Stimulation_Buffer
 * OVTK_NodeId_Stimulation_Buffer
...
#define OVTK_NodeId_Stimulation_Stimulation_SampleIndex    EBML::CIdentifier(0x00B866D8, 0x14DA5374)
...
/*
#define OVTK_NodeId_                                       EBML::CIdentifier(0x007855DE, 0x3748D375)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x0011D6B7, 0x48F1AA39)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x003EC620, 0x333E0A94)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x0018C291, 0x7985DFDD)

#define OVTK_NodeId_                                       EBML::CIdentifier(0x006ACD74, 0x1C960C26)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x002F8FB7, 0x6DA7552D)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x00D62974, 0x473D4AA5)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x0041FD0A, 0x6BCD9A99)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x00DF7DD9, 0x33336C51)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x0069BB84, 0x3FC8E149)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x003F11B9, 0x26D76D9C)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x00EB1F23, 0x51C23B83)
#define OVTK_NodeId_                                       EBML::CIdentifier(0x00874A7F, 0x60DC34C2)

#define OVTK_NodeId_                                       EBML::CIdentifier(0x00C8C393, 0x31CE5B3E)
