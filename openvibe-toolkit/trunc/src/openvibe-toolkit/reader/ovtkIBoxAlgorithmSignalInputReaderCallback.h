...
{
	class OVTK_API IBoxAlgorithmSignalInputReaderCallback : virtual public OpenViBEToolkit::IBoxAlgorithmInputReaderCallback
	{
	public:
	...
	extern OVTK_API OpenViBEToolkit::IBoxAlgorithmSignalInputReaderCallback* createBoxAlgorithmSignalInputReaderCallback(OpenViBEToolkit::IBoxAlgorithmSignalInputReaderCallback::ICallback& rCallback);
	extern OVTK_API void releaseBoxAlgorithmSignalInputReaderCallback(OpenViBEToolkit::IBoxAlgorithmSignalInputReaderCallback* pBoxAlgorithmSignalInputReaderCallback);
};
