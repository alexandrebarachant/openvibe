#ifndef __OpenViBEToolkit_Reader_IStreamedMatrixReaderCallbackHelper_H__
#define __OpenViBEToolkit_Reader_IStreamedMatrixReaderCallbackHelper_H__

#include "ovtkIBoxAlgorithmInputReaderCallback.h"

namespace OpenViBEToolkit
{
	class OVTK_API IStreamedMatrixReaderCallbackHelper : virtual public OpenViBEToolkit::IBoxAlgorithmInputReaderCallback
	{
	public:
		...
		class OVTK_API TCallbackProxy1 : virtual public OpenViBEToolkit::IStreamedMatrixReaderCallbackHelper::ICallback
		{
		public:
			TCallbackProxy1(
		...
		template <class COwnerClass, void (COwnerClass::*fpSetMatrixDimmensionCount)(const OpenViBE::uint32 ui32DimmensionCount), void (COwnerClass::*fpSetMatrixDimmensionSize)(const OpenViBE::uint32 ui32DimmensionIndex, const OpenViBE::uint32 ui32DimmensionSize), void (COwnerClass::*fpSetMatrixDimmensionLabel)(const OpenViBE::uint32 ui32DimmensionIndex, const OpenViBE::uint32 ui32DimmensionEntryIndex, const char* sDimmensionLabel), void (COwnerClass::*fpSetMatrixBuffer)(const OpenViBE::float64* pBuffer)>
		class OVTK_API TCallbackProxy2 : virtual public OpenViBEToolkit::IStreamedMatrixReaderCallbackHelper::ICallback
		{
		public:
			TCallbackProxy2(
				COwnerClass& rOwnerObject)
			...
			virtual void setMatrixDimmensionCount(const OpenViBE::uint32 ui32DimmensionCount)
			{
				if(m_fpSetMatrixDimmensionCount)
				{
					(m_rOwnerObject.*m_fpSetMatrixBuffer)(ui32DimmensionCount);
				}
			}
			virtual void setMatrixDimmensionSize(const OpenViBE::uint32 ui32DimmensionIndex, const OpenViBE::uint32 ui32DimmensionSize)
			{
	...
	extern OVTK_API OpenViBEToolkit::IStreamedMatrixReaderCallbackHelper* createStreamedMatrixReaderCallbackHelper(OpenViBEToolkit::IStreamedMatrixReaderCallbackHelper::ICallback& rCallback);
	extern OVTK_API void releaseStreamedMatrixReaderCallbackHelper(OpenViBEToolkit::IStreamedMatrixReaderCallbackHelper* pStreamedMatrixReaderCallbackHelper);
};

#endif // __OpenViBEToolkit_Reader_IStreamedMatrixReaderCallbackHelper_H__
