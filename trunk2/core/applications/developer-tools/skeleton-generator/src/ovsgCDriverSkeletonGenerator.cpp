...
void CDriverSkeletonGenerator::buttonOkCB()
{
	...
	CString l_sTemplate(OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/driver.h-skeleton");
	...
	l_sTemplate = OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/driver.cpp-skeleton";
	...
	l_sTemplate = OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/configuration.h-skeleton";
	...
	l_sTemplate = OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/configuration.cpp-skeleton";
	...
	l_sTemplate = OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/interface.ui-skeleton";
	...
	l_sTemplate = OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/readme-driver.txt-skeleton";
