	...
	namespace SimpleVisualisation
	{
		...
		public:
				...
				OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
				...
				rBoxAlgorithmPrototype.addSetting("Interface filename",              OV_TypeId_Filename,    "${Path_Data}/openvibe-plugins/simple-visualisation/p300-identifier-card.ui");
				...
				rBoxAlgorithmPrototype.addSetting("Background Card filename",        OV_TypeId_Filename,    "${Path_Data}/openvibe-plugins/simple-visualisation/p300-magic-card/openvibe-logo.png");
