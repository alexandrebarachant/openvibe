#ifndef __OpenViBE_Kernel_IProcessingUnit_H__
#define __OpenViBE_Kernel_IProcessingUnit_H__
...
namespace OpenViBE
{
	namespace Kernel
	{
		...
		public:
			...
			_IsDerivedFromClass_(OpenViBE::Kernel::IAttributable, OV_ClassId_Kernel_ProcessingUnit)
		};
	};
};

#endif // __OpenViBE_Kernel_IProcessingUnit_H__
