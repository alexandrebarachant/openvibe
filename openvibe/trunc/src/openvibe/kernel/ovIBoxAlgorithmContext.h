#ifndef __OpenViBE_Kernel_IBoxAlgorithmContext_H__
#define __OpenViBE_Kernel_IBoxAlgorithmContext_H__
...
namespace OpenViBE
{
	namespace Kernel
	{
		...
		public:
			...
			_IsDerivedFromClass_(OpenViBE::Kernel::IKernelObject, OV_ClassId_Kernel_BoxAlgorithmContext)
		};
	};
};

#endif // __OpenViBE_Kernel_IBoxAlgorithmContext_H__
