#ifndef __OpenViBE_Kernel_ILogListener_h__
#define __OpenViBE_Kernel_ILogListener_h__
...
namespace OpenViBE
{
	namespace Kernel
	{
		...
		class OV_API ILogListener : virtual public OpenViBE::Kernel::IKernelObject
		{
		public:
			...
			_IsDerivedFromClass_(OpenViBE::Kernel::IKernelObject, OV_ClassId_Kernel_LogListener);
		};
	};
};

#endif // __OpenViBE_Kernel_ILogListener_h__
