#ifndef __OpenViBE_Kernel_IBoxIO_H__
#define __OpenViBE_Kernel_IBoxIO_H__
...
namespace OpenViBE
{
	namespace Kernel
	{
		...
		public:
			...
			_IsDerivedFromClass_(OpenViBE::Kernel::IKernelObject, OV_ClassId_Kernel_BoxIO)
		};
	};
};

#endif // __OpenViBE_Kernel_IBoxIO_H__
