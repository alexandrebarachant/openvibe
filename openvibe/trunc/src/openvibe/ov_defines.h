...
#define OV_ClassIdentifier_ObjectFactory                    OpenViBE::CIdentifier(0x04D88707, 0x21F2F456)
...
#define OV_ClassIdentifier_Manager                          OpenViBE::CIdentifier(0x110AAB4F, 0x157CBEF1)

#define OV_ClassIdentifier_PluginModule                     OpenViBE::CIdentifier(0x74EAC344, 0x375C88EC)
#define OV_ClassIdentifier_PluginManager                    OpenViBE::CIdentifier(0x690ED3AC, 0x2D0702F0)
...
#define OV_ClassIdentifier_Link                             OpenViBE::CIdentifier(0x38F6E10D, 0x6BA2721A)
#define OV_ClassIdentifier_Scenario                         OpenViBE::CIdentifier(0x6EED456C, 0x2FC6F03A)

#define OV_ClassIdentifier_Player                           OpenViBE::CIdentifier(0x790A8CC5, 0x1439C776)
