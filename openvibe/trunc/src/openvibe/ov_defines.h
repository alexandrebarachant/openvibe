...
#define OV_ClassId_Kernel_BoxIO                            OpenViBE::CIdentifier(0x110AAB4F, 0x157CBEF1)
#define OV_ClassId_Kernel_Link                             OpenViBE::CIdentifier(0x38F6E10D, 0x6BA2721A)
#define OV_ClassId_Kernel_ProcessingUnit                   OpenViBE::CIdentifier(0x3681EC07, 0x337DE51F)
...
#define OV_ClassId_Kernel_Player                           OpenViBE::CIdentifier(0x790A8CC5, 0x1439C776)
...
#define OV_ClassId_Kernel_Message                          OpenViBE::CIdentifier(0x64DCCE4E, 0x530CA785)
#define OV_ClassId_Kernel_MessageClock                     OpenViBE::CIdentifier(0x58AE3092, 0x0C3371A7)
#define OV_ClassId_Kernel_MessageEvent                     OpenViBE::CIdentifier(0x1B9B49DB, 0x6DA217E7)
#define OV_ClassId_Kernel_MessageSignal                    OpenViBE::CIdentifier(0x4E1709E5, 0x38AADA6C)

#define OV_ClassId_Kernel_BoxAlgorithmContext              OpenViBE::CIdentifier(0x275F4BB8, 0x49E08D24)
#define OV_ClassId_Kernel_ScenarioImporterContext          OpenViBE::CIdentifier(0x734C0B6A, 0x7EFEBBC8)
#define OV_ClassId_Kernel_ScenarioExporterContext          OpenViBE::CIdentifier(0x583A5B71, 0x2C06662D)
#define OV_ClassId_Kernel_BoxProto                         OpenViBE::CIdentifier(0x169ED1C1, 0x639C5957)
#define OV_ClassId_Kernel_PlayerContext                    OpenViBE::CIdentifier(0x1F8D3E14, 0x73A4DB1F)
...
/*
#define OV_ClassId_                                        OpenViBE::CIdentifier(0x624A6E5B, 0x52228CEA)
#define OV_ClassId_                                        OpenViBE::CIdentifier(0x2A49A89B, 0x78843238)
#define OV_ClassId_                                        OpenViBE::CIdentifier(0x330306DD, 0x74A95F98)
