#ifndef __OV_DOCCREATINGNEWPLUGINS_H__
#define __OV_DOCCREATINGNEWPLUGINS_H__
 ...
 *  - for box behavior : OpenViBE::Plugins::IBoxBehaviorDesc and OpenViBE::Plugins::IBoxBehavior
...
#endif // __OV_DOCCREATINGNEWPLUGINS_H__
